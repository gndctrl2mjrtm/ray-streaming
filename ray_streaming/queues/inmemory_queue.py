...
logo = """
    ____              _____                          
   / __ \____ ___  __/ ___/___  ______   _____  _____
  / /_/ / __ `/ / / /\__ \/ _ \/ ___/ | / / _ \/ ___/
 / _, _/ /_/ / /_/ /___/ /  __/ /   | |/ /  __/ /    
/_/ |_|\__,_/\__, //____/\___/_/    |___/\___/_/     
            /____/                                  
"""
...
#     s = RayServer()
#     # s.default_
#     s.add_task(fnc, 'localhost:6006', 'input_queue')
#     s.add_task(fnc1, 'input_queue', 'output_queue')


class RayServePkg(object):
